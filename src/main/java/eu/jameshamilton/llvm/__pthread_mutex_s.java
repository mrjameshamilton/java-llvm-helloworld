...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        LLVM.C_INT.withName("__lock"),
        LLVM.C_INT.withName("__count"),
        LLVM.C_INT.withName("__owner"),
        LLVM.C_INT.withName("__nusers"),
        LLVM.C_INT.withName("__kind"),
        LLVM.C_SHORT.withName("__spins"),
        LLVM.C_SHORT.withName("__elision"),
