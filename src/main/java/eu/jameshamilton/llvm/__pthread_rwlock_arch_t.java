...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        LLVM.C_INT.withName("__readers"),
        LLVM.C_INT.withName("__writers"),
        LLVM.C_INT.withName("__wrphase_futex"),
        LLVM.C_INT.withName("__writers_futex"),
        LLVM.C_INT.withName("__pad3"),
        LLVM.C_INT.withName("__pad4"),
        LLVM.C_INT.withName("__cur_writer"),
        LLVM.C_INT.withName("__shared"),
        LLVM.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, LLVM.C_CHAR).withName("__pad1"),
        LLVM.C_LONG.withName("__pad2"),
        LLVM.C_INT.withName("__flags"),
